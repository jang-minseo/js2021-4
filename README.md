...
- 메소드중 reload() > 새로고침 이라는 메소드를 가장 많이 사용함
...
- jQuery 라이브러리는 $ 함수 활용
- $ 함수의 매게 변수에는 문서 객체, CSS형식, HTML 형식의 문자열 삽입
- jQuery의 객체 생성
...
// CSS 선택자로 jQuery 객체를 생성
$('h1')

// HTML 선택자로 jQuery 객체를 생성
$('<h1>'</h1'>)
```
